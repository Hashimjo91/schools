...
import static com.applikable.Schools.Utilities.CommonUtilities.DISPLAY_MESSAGE_ACTION;
import static com.applikable.Schools.Utilities.CommonUtilities.EXTRA_MESSAGE;
...
public class mainpage extends Activity {
    ...
    int back = 0;
    int i = 0;
    public BroadcastReceiver mHandleMessageReceiver;
...
//    actionBar.setDisplayHomeAsUpEnabled(true);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mObj asdadss=new obj("عن المدرسة", R.mipmap.aboutblack);
