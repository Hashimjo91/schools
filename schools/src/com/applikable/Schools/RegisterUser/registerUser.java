    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final UserChildAdapter<childList> mAdapter = new UserChildAdapter<childList>() {
            ...
            public View GetView(final int position, View view, ViewGroup viewGroup) {
                ...
                int q=0;
                switch (getItem(position).getSClass()) {
                ...
                ((Spinner) v.findViewById(R.id.Sclass)).setSelection(q);
...
// Set up the buttons
        ...
        (findViewById(R.id.Save)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String Operator = ((Spinner) findViewById(R.id.SOperator)).getSelectedItem().toString().equals("79")?"69":((Spinner) findViewById(R.id.SOperator)).getSelectedItem().toString().equals("77")?"70":"71";
...
//                            Log.e("NewMessage:",newMessage);
                    ...
                    protected Void doInBackground(Void... voids) {
                        try {
                            ...
                            Log.e("response", SchoolParser.registerUser(c, PhoneNumber, fName, lName, Emain, Bday, Gender, Operator, Tools.getShared(registerUser.this, "regid",""), list)+"1");
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
