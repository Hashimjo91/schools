...
//        super.onBackPressed();
    ...
    class mAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            db.delete("Sessions");
            db.delete("Note");
            String isDone = SchoolParser.getshced(sched.this, ids[0], ids[1], ids[2]);
...
//            Toast.makeText(sched.this, "Done", Toast.LENGTH_SHORT).show();
            ...
            th.getTabWidget().getChildAt(0).setBackgroundColor(Color.parseColor("#5E6F13"));
            ...
            th.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
                ...
                public void onTabChanged(String s) {
                    ...
                    th.getTabWidget().getChildAt(selected).setBackgroundColor(Color.parseColor("#5E6F13"));
