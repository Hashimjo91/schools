...
public class SchoolParser {
    ...
    public static String registerUser(String MobileNumber, String FirstName, String LastName, String PrimaryEmail, String DateOfBirth, String GenderId, String Operator, String RegKey, List<childList> list) {
        String response = null;
        HttpClient httpClient = new DefaultHttpClient();
...
//          = myLogin.getPageContentFirst("http://eduwave.elearning.jo/Eduwave/eduwave_sms/studentmarks.aspx");
    ...
    public static String getPartialPage(Context context, String url) {
        ...
        try {
            ...
            Elements elements = d.select("body > div.container > div.contant01 > div.nav02 > div.inner div.content");

            html = elements.get(3).toString();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String getParsedActivities(Context context) {
        ...
        try {
            Document document = Jsoup.connect("http://www.omareyah.com/announcement").get();

            DataBase db = new DataBase(context);
            Elements elements = document.select("div.view-content > div > ul");
            Elements lis = elements.select("li");

            int i = 0;
            for (Element e : lis) {
                String link = e.select("span > a").attr("href");
                ...
                db.insertNews(i + "", text, "http://www.omareyah.com" + link, img, "101", "activities");
                i++;
            }
    ...
    public static String getParsedNews(Context context) {
        ...
        try {
            ...
            Document document = Jsoup.connect("http://www.omareyah.com/news").get();
            ...
            for (Element e : lis) {
                ...
                db.insertNews(i + "", text, "http://www.omareyah.com/" + link, img, "100", "news");
                i++;
            }
